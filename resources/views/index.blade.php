...
@section('content')
                    ...
                    <tbody>
                        @forelse($backupStatuses as $backupStatus)
                            ...
                            <tr>
                                ...
                                <td>@if($newestBackup === null) No backups present @else {{ $newestBackup->date()->locale('en')->diffForHumans() }} @endif</td>
    ...
    <div class="modal fade" id="laravel-backup-panel-delete-modal" tabindex="-1" aria-labelledby="laravel-backup-panel-delete-title" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered"><div class="modal-content">
            <div class="modal-body"><h2 class="h5 mb-3" id="laravel-backup-panel-delete-title">Delete backup</h2><span class="text-muted" data-laravel-backup-panel-delete-message data-message-template="Are you sure you want to delete :backup?"></span></div>
